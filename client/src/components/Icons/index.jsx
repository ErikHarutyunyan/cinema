export const IcChSelected = ({ style, className }) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={style} className={className}>
      <rect x="1.26315" y="8.84229" width="21.4737" height="13.2632" rx="3.15789" fill="#FB7B1F" />
      <rect x="4" y="2" width="16" height="17" rx="3.15789" fill="#FB7B1F" stroke="black" strokeWidth="1.89474" />
    </svg>
  );
};
...
export const IcChTaken = ({ style, className }) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={style} className={className}>
      <rect x="1.26315" y="8.84229" width="21.4737" height="13.2632" rx="3.15789" fill="white" />
      <rect x="4" y="2" width="16" height="17" rx="3.15789" fill="white" stroke="black" strokeWidth="1.89474" />
    </svg>
  );
};
...
export const IcCheck = ({ style, className }) => {
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {' '}
        <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#69be13" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>{' '}
      </g>
    </svg>
  );
};
